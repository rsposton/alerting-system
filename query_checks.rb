def init_query
  list_of_checks =  [{"num"=>0,"name"=>"Traffic Exceeds Hourly Threshold",
                      ...
                      "distro"=>["regan@milyoni.com","david@milyoni.com","manasi@milyoni.com","dean@milyoni.com","sheila@milyoni.com","john@milyoni.com","joe@milyoni.com","emily@milyoni.com"]},
                      {"num"=>1,"name"=>"New Pack Created",
                       ...
                       "database_connection"=>"mysql://vcread:LTAty3CH6dcHXReB@69.162.175.147/videocards",
                       "distro"=>["regan@milyoni.com","david@milyoni.com","manasi@milyoni.com","dean@milyoni.com","sheila@milyoni.com","joe@milyoni.com","emily@milyoni.com"]},
