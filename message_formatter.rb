def format_results(check,results,send_results)
  ...
  send_results.each do |row|
    ...
    while j < results.fields.count
      ...
      milyoni_flag = (['108.227.100.152','173.164.182.62','203.196.159.34','24.5.251.254','61.16.241.214','76.103.249.126','173.164.182.61','216.70.158.117','71.233.236.125','24.4.40.180','208.73.113.6','38.75.7.150','174.97.170.245'].include? row[results.fields[j]].to_s) ? '(Mily)' : ''
